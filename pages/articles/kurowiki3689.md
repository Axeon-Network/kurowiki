...
**KuroWiki build 3689** is a Beta 6 build of [KuroWiki](KuroWiki). It is the first build to be compiled from the `kayaurora` branch, and was compiled on 13 October 2025 02:39 UTC+3 (17:39 UTC-6 the day prior).
