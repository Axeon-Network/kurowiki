...
# Plot
After powering on the NekoCraft server for the first time, Kit and KayAurora start a journey to find a good location to make the city of Fucking. They go from underwater to a snow land, some villages and thousands of blocks in the air via Elytra.
...
<div class="wiki-gallery">
    ...
    {% include gallery_item.html 
        ...
        alt_text="Poster #6, featuring Kit and KayAurora" 
        caption="Poster #6, featuring Kit and KayAurora"
        author='Kit64'
        style="" %}
</div>
