...
currentVersion='v26.5'
currentVersionReleaseDate='2026-05-14'
sourceModel='Open source'
repoLink='https://github.com/AveryEclipse/averyeclipse.github.io'
repoHost='GitHub'
status='Available'
link='https://avery.is-a.dev'
image='resources/img/articles/kaywebsite/v26.5.png'
%}
...
v26.5, released 14 May 2026, further expanded on the rollout of `astro-icon` icons by replacing Unicode emojis in page and section headings.
...
<div class="wiki-gallery">
    ...
    {% include gallery_item.html 
        image_src="resources/img/articles/kaywebsite/v26.5.png" 
        caption="AveryWebsite v26.5, May 2026" %}
    {% include gallery_item.html 
        image_src="resources/img/articles/kaywebsite/v26.5-retro.png" 
