...
June and July 2026 have seen videos on Swapping Etcs (*[Swapping Linux /etc directories!](Swapping_Linux_/etc_directories!)*), Microsoft Bob (*[Microsoft's Failed "User-Friendly" Shell for Windows (Microsoft Bob)](Microsoft's_Failed_"User-Friendly"_Shell_for_Windows_(Microsoft_Bob))*), Modern Programs on 98 (*[Modern Programs in Windows 98! (w/ Linux X11 Servers)](Modern_Programs_in_Windows_98!_(w/_Linux_X11_Servers))*) and upgrading the XP Mode VM (*[What happens if you upgrade the Windows XP Mode VM?](What_happens_if_you_upgrade_the_Windows_XP_Mode_VM?)*).

On 8 July 2026, the AstroNT channel reached 1,000 subscribers, which was celebrated with a [stream](https://www.youtube.com/live/amFxXFCdGfQ), the first livestream ever made on the channel.
